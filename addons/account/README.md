...
The Eagle <a href="https://www.eagle.com/page/accounting">Open Source Accounting</a> app allows a better way to
...
in one place. Eagle's user interface is designed with productivity in mind.
...
accounting; Eagle has all the features you need to sustain all your business
activities.

Scale With Your Organization
----------------------------

Eagle supports multiple currencies, multiple users with different access rights,
