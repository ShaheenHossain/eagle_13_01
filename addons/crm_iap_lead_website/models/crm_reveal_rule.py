...
from eagle.addons.iap import jsonrpc
from eagle.addons.crm.models import crm_stage
from eagle.exceptions import ValidationError

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap-services.eagle.com'
...
class CRMRevealRule(models.Model):
    ...
    industry_tag_ids = fields.Many2many('crm.iap.lead.industry', string='Industries', help='Leave empty to always match. Eagle will not create lead if no match')
