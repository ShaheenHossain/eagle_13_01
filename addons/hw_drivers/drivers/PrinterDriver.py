...
from eagle.addons.hw_drivers.controllers.driver import event_manager, Driver, PPDs, conn, printers, cups_lock, iot_devices
from eagle.addons.hw_drivers.tools import helpers
from eagle.addons.hw_proxy.controllers.main import drivers as old_drivers
...
def print_star_error(deviceId):
    ...
    error_page = (
        ...
        "http://www.eagle.com"  # TODO: Replace URL
        "\x0A\x0A"
...
class PrinterDriver(Driver):
    ...
    def send_status(self):
        """ Sends the current status of the printer to the connected Eagle instance.
        """
        self.data = {
            'value': '',
            'state': self.state,
