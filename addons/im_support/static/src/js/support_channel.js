eagle.define('im_support.SupportChannel', function (require) {
"use strict";
...
var SupportChannel = SearchableThread.extend({
    ...
    _fetchMessages: function (pDomain, loadMore) {
        ...
        return supportSession.rpc('/eagle_im_support/fetch_messages', {
                domain: domain,
    ...
    _postMessage: function (data) {
        ...
        return supportSession.rpc('/eagle_im_support/chat_post', {
