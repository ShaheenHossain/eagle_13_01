eagle.define('partner_autocomplete.tests', function (require) {
    "use strict";
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "eagle.com/logo.png" ? "eaglebase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
                    ...
                    _getEagleSuggestions: function (value, isVAT) {
                    ...
                    _getClearbitSuggestions: function (value) {
                        return this._getEagleSuggestions(value);
                    },
    ...
    QUnit.test("Partner autocomplete : Company type = Individual", function (assert) {
        ...
        createView({
            ...
            testUtils.fields.editInput($input, "eagle")
    ...
    QUnit.test("Partner autocomplete : Company type = Company / Name search", async function (assert) {
        ...
        var form = await createView({
            ...
            await testUtils.fields.editInput($input, "eagle");
            ...
            await testUtils.nextTick();
            $dropdown = form.$(".o_field_partner_autocomplete .dropdown-menu:visible");
            assert.strictEqual($dropdown.length, 1, "there should be an opened dropdown when typing eagle letters again");
