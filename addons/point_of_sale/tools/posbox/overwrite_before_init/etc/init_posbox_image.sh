...
wget 'https://nightly.eagle.com/master/iotbox/eftdvs' -P /usr/local/bin/
chmod +x /usr/local/bin/eftdvs
wget 'https://nightly.eagle.com/master/iotbox/eftapi.so' -P /usr/lib/
...
mkdir /var/log/eagle
chown pi:pi /var/log/eagle
chown pi:pi -R /home/pi/eagle/
...
echo "* * * * * rm /var/run/eagle/sessions/*" | crontab -
...
echo "addons/hw_drivers/drivers/" > /home/pi/eagle/.git/info/exclude
