...
from eagle.osv.expression import FALSE_DOMAIN, OR

from eagle.addons.http_routing.models.ir_http import ModelConverter, _guess_mimetype
from eagle.addons.portal.controllers.portal import _build_url_w_params
...
class Http(models.AbstractModel):
    ...
    def _dispatch(cls):
        """
        In case of rerouting for translate (e.g. when visiting eagle.com/fr_BE/),
