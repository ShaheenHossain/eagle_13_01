...
`cla-submission` `at` `eagle.com`.  In that case someone from the Eagle team will
make the pull request on your behalf.

* Printable Eagle CCLA v1.0 https://www.eagle.com/files/legal/Eagle-CCLA-v1.0.pdf
* Printable Eagle ICLA v1.0 https://www.eagle.com/files/legal/Eagle-ICLA-v1.0.pdf
