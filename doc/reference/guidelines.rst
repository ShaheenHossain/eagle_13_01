:banner: banners/eagle_guideline.jpg
...
.. warning::
    ...
    details, see our `pull request guide <https://eagle.com/submit-pr>`_.
...
File naming is important to quickly find information through all eagle addons.
This section explains how to name files in a standard eagle module. As an
example we use a `plant nursery <https://github.com/tivisse/eagledays-2018/tree/master/plant_nursery>`_ application.
...
directory. This naming comes from old eagle applications using the wizard
...
- The tag *<data>* is only used to set not-updatable data with ``noupdate=1``.
  ...
  set on the ``<eagle>`` tag and do not set a ``<data>`` tag.
...
.. code-block:: python
    ...
    # 2 : imports of eagle
    import eagle
    from eagle import api, fields, models, _ # alphabetically ordered
    from eagle.tools.safe_eval import safe_eval as eval
    # 3 : imports from eagle addons
    from eagle.addons.website.models.website import slug
    from eagle.addons.web.controllers.main import login_redirect
...
More precise JS guidelines are detailed in the `github wiki  <https://github.com/eagle/eagle/wiki/Javascript-coding-guidelines>`_.
