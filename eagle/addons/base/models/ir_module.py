...
import eagle
from eagle import api, fields, models, modules, tools, _
from eagle.addons.base.models.ir_model import MODULE_UNINSTALL_FLAG
from eagle.exceptions import AccessDenied, UserError
from eagle.osv import expression
from eagle.tools.parse_version import parse_version
from eagle.tools.misc import topological_sort
...
class Module(models.Model):
    ...
    def get_apps_server(self):
        return tools.config.get('apps_server', 'https://apps.eagle.com/apps')
