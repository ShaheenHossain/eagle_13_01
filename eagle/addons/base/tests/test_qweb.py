...
from eagle.modules import get_module_resource
from eagle.tests.common import TransactionCase
from eagle.addons.base.models.qweb import QWebException
from eagle.tools import misc, ustr
...
class TestQWebNS(TransactionCase):
    ...
    def test_render_dynamic_xml_with_code_error(self):
        ...
        view1 = self.env['ir.ui.view'].create({
            ...
            'arch': u"""
                <t t-name="base.dummy">
                    <Invoice xmlns:od="http://eagle.com/od">
