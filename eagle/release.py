...
product_name = 'Eagle'
description = 'Eagle Server'
long_desc = '''Eagle is a complete ERP and CRM. The main features are accounting (analytic
...
nt_service_name = "eagle-server-" + series.replace('~','-')
